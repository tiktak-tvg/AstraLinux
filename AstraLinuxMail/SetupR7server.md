...
Common Name или FQDN|	FQDN (fully qualified domain name) - это полное доменное имя вашего сайта. Он должен совпадать с тем, что пользователи вводят в веб-браузере	|admin.it.company.lan
Email Address|	Адрес электронной почты, используемый для связи с веб-мастером сайта	|info@admin.it.company.lan
