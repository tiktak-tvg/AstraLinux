...
DHCPACK — получив DHCPREQUEST и убедившись, что в сообщении его идентификатор, сервер проверяет, свободен ли запрошенный адрес.
             ...
             Получив DHCPACK, клиент обязан убедиться в уникальности IP-адреса средствами протокола ARP и зафиксировать суммарный срок аренды.

Срок аренды — время, прошедшее между отправкой сообщения DHCPREQUEST и приёмом ответного DHCPACK, плюс срок аренды, указанный в DHCPACK.
